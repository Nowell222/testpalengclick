...
const DashboardLayout = ({ role }: DashboardLayoutProps) => {
  ...
  // Sidebar inner content — shared between mobile overlay and desktop static
  const SidebarContent = () => (
    // height: 100% of the aside, flex column, never scrolls as a whole
    <div className="flex h-full flex-col">
      ...
      {/* ── Nav links — scrollable if too many items ───────────────────── */}
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        ...
        {/* Top bar */}
        <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b bg-background/95 backdrop-blur-sm px-4">
          <button
