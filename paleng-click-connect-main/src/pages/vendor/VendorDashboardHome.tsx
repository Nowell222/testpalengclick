  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 style={{ fontSize: "clamp(1.15rem, 5vw, 1.5rem)", fontWeight: 700 }}>
      ...
      {d.isCurrentMonthPaid ? (
        <motion.div
          ...
          className="rounded-2xl border border-success/20 bg-success/5 px-4 py-3 flex flex-wrap items-center justify-between gap-2"
        >
        ...
        <motion.div
          initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
          className="rounded-2xl border border-accent/20 bg-accent/5 px-4 py-3 flex flex-wrap items-center justify-between gap-2"
        >
          <div className="flex items-center gap-3">
      ...
      <div className="grid gap-3" style={{ gridTemplateColumns: "repeat(2, 1fr)" }}>
        {[
          ...
          <div key={c.label} className="rounded-2xl border bg-card shadow-civic" style={{ padding: "clamp(0.65rem, 2.5vw, 1rem)" }}>
            ...
            <p className={`font-mono font-bold ${c.color}`} style={{ fontSize: "clamp(0.85rem, 3.5vw, 1.125rem)" }}>{c.value}</p>
      ...
      <div className="grid gap-5" style={{ gridTemplateColumns: "1fr" }}>
        ...
        <div className="space-y-4">
          ...
          <motion.div whileHover={{ y: -2 }} className="rounded-2xl border bg-card p-5 shadow-civic">
            ...
            <p className="font-mono font-bold text-foreground leading-none" style={{ fontSize: "clamp(1.4rem, 6vw, 1.875rem)" }}>
